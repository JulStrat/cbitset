...
#else
        card += pop_count(bitset->array[k]);
        card += pop_count(bitset->array[k + 1]);
        card += pop_count(bitset->array[k + 2]);
        card += pop_count(bitset->array[k + 3]);
        card += pop_count(bitset->array[k + 4]);
        card += pop_count(bitset->array[k + 5]);
        card += pop_count(bitset->array[k + 6]);
        card += pop_count(bitset->array[k + 7]);
#endif
    }
